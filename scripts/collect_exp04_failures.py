#!/usr/bin/env python3
"""Collect and classify exp04 client container exits from Docker."""
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Collect exp04 client failures from Docker state/logs")
    parser.add_argument("--compose-file", default="docker/docker-compose.exp04_validation.yml")
    parser.add_argument("--outputs-dir", default="outputs/exp04_reduced_sampling_iid")
