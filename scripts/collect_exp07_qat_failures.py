#!/usr/bin/env python3
"""Collect and classify exp07_qat client container exits from Docker."""
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Collect exp07_qat client failures from Docker state/logs")
    parser.add_argument("--compose-file", default="docker/docker-compose.exp07_qat_validation.yml")
    parser.add_argument("--outputs-dir", default="outputs/exp07_qat_int8")
