#!/usr/bin/env python3
"""Collect and classify exp07 client container exits from Docker."""
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Collect exp07 client failures from Docker state/logs")
    parser.add_argument("--compose-file", default="docker/docker-compose.exp07_validation.yml")
    parser.add_argument("--outputs-dir", default="outputs/exp07_int8_weak_clients")
