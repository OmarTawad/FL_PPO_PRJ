#!/usr/bin/env python3
"""Collect and classify exp06 client container exits from Docker."""
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Collect exp06 client failures from Docker state/logs")
    parser.add_argument("--compose-file", default="docker/docker-compose.exp06_validation.yml")
    parser.add_argument("--outputs-dir", default="outputs/exp06_quant16_weak_clients")
