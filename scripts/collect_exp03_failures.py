#!/usr/bin/env python3
"""Collect and classify exp03 client container exits from Docker."""
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Collect exp03 client failures from Docker state/logs")
    parser.add_argument("--compose-file", default="docker/docker-compose.exp03_validation.yml")
    parser.add_argument("--outputs-dir", default="outputs/exp03_heterogeneous_noniid")
