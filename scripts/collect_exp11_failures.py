#!/usr/bin/env python3
"""Collect and classify exp11 client container exits from Docker."""
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Collect exp11 client failures from Docker state/logs")
    parser.add_argument("--compose-file", default="docker/docker-compose.exp11_validation.yml")
    parser.add_argument("--outputs-dir", default="outputs/exp11_ppo_bf16_int8")
