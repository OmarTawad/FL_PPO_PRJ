#!/usr/bin/env python3
"""Collect and classify exp09 client container exits from Docker."""
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Collect exp09 client failures from Docker state/logs")
    parser.add_argument("--compose-file", default="docker/docker-compose.exp09_validation.yml")
    parser.add_argument("--outputs-dir", default="outputs/exp09_uniform_int8_all")
