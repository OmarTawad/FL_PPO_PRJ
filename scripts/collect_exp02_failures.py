#!/usr/bin/env python3
"""Collect and classify exp02 client container exits from Docker."""
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Collect exp02 client failures from Docker state/logs")
    parser.add_argument("--compose-file", default="docker/docker-compose.exp02_validation.yml")
    parser.add_argument("--outputs-dir", default="outputs/exp02_baseline_b")
    parser.add_argument("--run-id", default="", help="Optional run_id (e.g., run_20260307_123456)")
