...
log="outputs/exp05_extreme_memory_limits/logs/exp05_full_${ts}.log"
compose="docker/docker-compose.exp05.yml"
observe_seconds="${OBSERVE_SECONDS:-3600}"

echo "[exp05] Full stress run log: ${log}"
