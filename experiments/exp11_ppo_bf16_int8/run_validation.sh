...
log="outputs/exp11_ppo_bf16_int8/logs/exp11_validation_${ts}.log"
compose="docker/docker-compose.exp11_validation.yml"
project="fl_ppo_exp11_val"
services=(
  server
